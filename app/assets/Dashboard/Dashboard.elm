...
init flags location =
    let
        minimapModel =
            Minimap.init flags.minimapBackground

        ( tagCarouselModel, tagCarouselCmd ) =
            TagCarousel.init location flags.addTagButton flags.deleteTagButton

        controlsModel =
            Controls.init flags.playButton flags.pauseButton
