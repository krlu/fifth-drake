        ...
        |> andThen
            (\v ->
                case decodeValue (field key decoder) v of
                    ...
                    Err e ->
                        Debug.log (key ++ " failed to parse") (fail e)
            )


populate : Location -> Cmd Msg
populate loc =
    Http.send SetGame <| getGame loc


getGame : Location -> Http.Request Game
getGame loc =
    Http.get (playerUrl loc) game
        ...
        |> andThen
            (\s ->
                case s of
                    ...
                    _ ->
                        fail <| s ++ " is not a proper side type"
            )
        ...
        |> andThen
            (\s ->
                case s of
                    ...
                    _ ->
                        fail <| s ++ " is not a proper role type"
            )
